...
def func(x):
    ...
    E_xx = -2 * u.math.pi * u.math.sin(2 * u.math.pi * x['x']) * u.math.sin(u.math.pi * x['y'])
...
def fx(x):
    return (
        ...
        - 8 * mu * u.math.pi ** 2 * u.math.cos(2 * u.math.pi * x['x']) * u.math.sin(u.math.pi * x['y'])
    )
...
def fy(x):
    return (
        ...
        * (
            ...
            - 2 * u.math.pi ** 2 * u.math.cos(u.math.pi * x['y']) * u.math.sin(2 * u.math.pi * x['x'])
        )
        - mu
        * (
            2 * u.math.pi ** 2 * u.math.cos(u.math.pi * x['y']) * u.math.sin(2 * u.math.pi * x['x'])
